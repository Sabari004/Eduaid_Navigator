                ...
                <div className="p-6" data-id="28">
                  <div className="grid gap-2" data-id="29">
                    <div className="mb-5" data-id="30">
                      <img src="https://www.creativeitinstitute.com/images/course/course_1663052056.jpg"></img>
                    </div>
                    <div className="grid gap-1" data-id="30">
                      ...
                      <p data-id="32">2024 Web Development</p>
                    </div>
                    <div className="grid gap-1" data-id="33">
                      ...
                      <p data-id="35">
                        Learn the basics of Web Development in this course.
                      </p>
                    </div>
                    <div className="grid gap-1" data-id="33">
                      <label
                    ...
                    <div className="grid gap-1" data-id="36">
                      <button className="w-full bg-red-600 p-3 rounded-md text-white font-bold">
                        Delete Course
                      </button>
                    </div>
                  </div>
